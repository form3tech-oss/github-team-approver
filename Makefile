...
DOCKER_IMG ?= 288840537196.dkr.ecr.eu-west-1.amazonaws.com/tech.form3/github-team-approver
DOCKER_TAG ?= $(VERSION)
...
.PHONY: install-deps
install-deps: install-aws install-dep install-faas install-goimports install-pact
